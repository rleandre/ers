...
document.getElementById("getEmployeeRequestsButton").addEventListener("click", getEmployeeLodgingRequests);
document.getElementById("getEmployeeRequestsButton").addEventListener("click", getEmployeeTravelRequests);
document.getElementById("getEmployeeRequestsButton").addEventListener("click", getEmployeeFoodRequests);
document.getElementById("getEmployeeRequestsButton").addEventListener("click", getEmployeeMiscellaneousRequests);
console.log("=================================================================================================")
